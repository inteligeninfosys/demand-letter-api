                ...
                container('gitops') {
                    withCredentials([
                        ...
                        sh '''
                            ...
                            yq -i '
                            (.images[] |
                            select(.name == "docker.io/inteligeninfosys/demand-letter-api-kb") |
                            ...
                            git commit \
                            -m "deploy(demand-letter-api): update UAT image to ${IMAGE_TAG}"
                ...
                container('gitops') {
                    withCredentials([
                        ...
                        sh '''
                            ...
                            PR_TITLE="Deploy demand-letter-api UAT ${IMAGE_TAG}"
